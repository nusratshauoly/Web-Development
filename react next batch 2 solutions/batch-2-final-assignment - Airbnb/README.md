## LWS-X-Airbnb - Hotel Booking Management

This is a Final Assignment poroject of [Learn With Sumit](https://learnwithsumit.com) Reactive accelarator Batch 2
...
| Email   | Password     |
| ------- | ------------ |
| x@x.com | bestPassw0rd |
| y@x.com | bestPassw0rd |
| z@x.com | bestPassw0rd |
| a@x.com | bestPassw0rd |
| b@x.com | bestPassw0rd |
...
-   Single Image Preview (Deatils page image show popup on click)
-   Multilangual Support (bn & en)
